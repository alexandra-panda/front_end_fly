    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="homepage.html"><span class="glyphicon glyphicon-home"></span>Acasă</a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right"> 
                    <li id = "cart">
                        <a class="navbar-brand" href="cartshow.php"><span class="glyphicon glyphicon-shopping-cart"></span>Coșul tău</a>
                    </li>                   
                    

                    <li class="dropdown" id = "new">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"> Logare&nbsp;</span><span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                          <li><a href="signup.html">Înregistrare</a></li>
                          
                          <li class="dropdown-submenu">
                            <a tabindex="-1" href="customersignin.html">Logare</a>
                      ...
                      <li class="dropdown" id = "old">
                        ...
                        <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                            <li><a href="#" id="logout">Deconectare</a></li>
                        </ul>
                        </li>
                </ul>
            </div>
...
$rowcount = mysqli_num_rows($result);
    ...
    if($rowcount == 0){
        echo "<div class='alert alert-info'><strong>Nu ai nimic în coșul tău</strong></div>";
    }
    else{
    echo "<div class='alert alert-info'>În cosuș tău ai:</div>";
